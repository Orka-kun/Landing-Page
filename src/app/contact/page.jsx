      ...
      <div
        ...
        <div>
          ...
          <div className="flex items-center mt-2 space-x-2 text-dark-600 ">
            ...
            <a href="mailto:orkadas@gmail.com">orkadas@gmail.com</a>
          </div>
          <div className="flex items-center mt-2 space-x-2 text-dark-600 ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                 stroke="currentColor" aria-hidden="true" className="w-4 h-4">
            ...
            <a href="tel:11111111111">+8801680422735</a>
          </div>
        </div>
        <div>
          <form>
            ...
            <button type="submit"
                    className="w-full py-4 font-semibold text-white transition-colors  bg-indigo-600 hover:bg-indigo-700 rounded-md focus:outline-none focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7">Send
              Message
            </button>
          </form>
        </div>
