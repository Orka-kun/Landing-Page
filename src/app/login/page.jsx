        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                    ...
                    <div>
                        <Link href="https://accounts.google.com/v3/signin/identifier?ifkv=AS5LTATCgAYsP0eUd1LiLRYAwuHLXMM7M5aovURToMRkP8rl8cldVDqD43_dk0N6Sgqb2eYN87G8qA&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S436960440%3A1719525746630378&ddm=0"
                            className="w-full flex items-center justify-center px-8 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
